...
contract DAORegistry is ERC6909, IERC6909MetadataURI, IDAORegistry {
    ...
    function createDAO(
        ...
        address daoTba = IERC6551Registry(registry6551).createAccount(
        ...
        address daoGov = 
            daoType == 1 || daoType == 2
                ? IGovernanceDeployer(governanceDeployer).deploy(daoId, daoTba)
                : address(0);
